...
class Config:
    def __init__(self,
                 valid_path = r'D:\CVML\Project\Heartchallenge_sound\Spectrogram\Peter_HeartSound_Log_Mel_Spectrogram_py\train_valid_test_2classes\valid',
                 target_size = (224,224),
...
model = load_model(r'D:\CVML\Project\Heartchallenge_sound\Codes\Py_code\DeepLearn\Peter_test_experiments\test_experiment_3\Heartbeat_Classification_CNN_Mel-Spectrogram_Peter_dataset.h5')
