...
model = load_model(r'D:\CVML\Project\Heartchallenge_sound\Codes\Py_code\DeepLearn\Physionet_test_experiments\test_1\Heartbeat_Classification_CNN_Mel-Spectrogram_Peter_dataset.h5')
