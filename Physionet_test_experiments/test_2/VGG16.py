...
#####VGG16 Model#######
model = Sequential([
Conv2D(32, (3, 3), input_shape=config.input_shape, padding='same', activation='relu'),
...
model.fit_generator(train_batches, steps_per_epoch=32,validation_data=valid_batches, validation_steps=47, epochs=45, class_weight='auto' ,verbose=2)
